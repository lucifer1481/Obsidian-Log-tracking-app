...
abstract class BaseMediaDetails : BaseResponse {
    ...
    // 🚀 FIXED: Forces English first! If English is missing or blank, it safely falls back to the original Romaji title.
